    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserWordFromId = table.Column<int>(nullable: false),
                    UserWordToId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Translations", x => new { x.UserWordFromId, x.UserWordToId });
                    table.ForeignKey(
                        name: "FK_Translations_UserWords_UserWordFromId",
                        column: x => x.UserWordFromId,
                        principalTable: "UserWords",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Translations_UserWords_UserWordToId",
                        column: x => x.UserWordToId,
                        principalTable: "UserWords",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                });
